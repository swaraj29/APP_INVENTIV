...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      {/* Desktop Nav - only visible above 1280px */}
      <div className="hidden xl:flex items-center justify-between w-full max-w-[1400px] mx-auto">
      ...
      {/* Hamburger Menu Icon - for mobile & tablet only */}
