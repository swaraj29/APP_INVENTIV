  ...
  return (
    <div className="bg-black text-white min-h-screen">
      ...
      <div className="flex">
        ...
        <div className="w-[45%] px-16 py-20">
          <h1 className="text-5xl font-light leading-tight mb-16 max-w-lg">
            We Create New Solutions And Transform Existing Ones With Technologies That Beat Industry-Best Timelines
          </h1>

          {/* Card section */}
          <div className="bg-zinc-900 rounded-2xl p-8 max-w-md relative">
            ...
            <div className="relative z-10">
              ...
              <button className="bg-blue-600 hover:bg-blue-700 transition-colors duration-200 px-6 py-3 rounded-lg font-medium text-white">
                Innovate With Us
              </button>
            </div>
          </div>
        ...
        {/* Right section - 55% width with scrollable content */}
        <div className="w-[55%] px-16 py-20">
          <div className="h-full overflow-y-auto max-h-[600px] pr-4">
            <div className="space-y-0">
              {features.map((feature, index) => (
                <div 
                  key={index} 
                  className="flex items-start gap-6 py-8 border-b border-gray-800 last:border-b-0 group cursor-pointer hover:bg-gray-900/20 transition-colors duration-200 px-4 -mx-4 rounded-lg"
                >
                  <div className="bg-white rounded-full p-3 mt-1 flex-shrink-0">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <ChevronRight className="w-5 h-5 text-gray-500 group-hover:text-white group-hover:translate-x-1 transition-all duration-200 flex-shrink-0 ml-4" />
                    </div>
